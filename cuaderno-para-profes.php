...
function cpp_cargar_assets() {
    ...
    // Returning to original filename but using a new handle for cache busting
    wp_enqueue_script('cpp-cuaderno-app', CPP_PLUGIN_URL . 'assets/js/cpp-cuaderno.js', ['cpp-core-js', 'cpp-programador-js'], $plugin_version, true);
