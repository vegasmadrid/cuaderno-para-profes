    ...
    <div class="cpp-cuaderno-viewport-classroom">
                ...
                <div id="cpp-actividades-top-bar-actions" style="display: none; align-items: center; gap: 10px; margin-left: auto;">
                    ...
                    <div class="cpp-filter-group">
                        ...
                        <select id="cpp-actividades-filter-criterio" class="cpp-select-sm">
                            ...
                            ?>
                            <option value="-1">Sin asignar criterio (<?php echo intval($counts['num_sin_criterio']); ?>)</option>
                            <option value="-2">No aplica (<?php echo intval($counts['num_no_aplica']); ?>)</option>
        ...
        <div id="cpp-general-settings-page-container" class="cpp-fullscreen-settings-page" style="display: none;">
            ...
            <div class="cpp-fullscreen-settings-content">
                <div class="cpp-config-container">
                    <div class="cpp-config-sidebar">
                        <a href="#" class="cpp-config-tab-link active" data-config-tab="calendario">
        ...
        <div class="cpp-cuaderno-main-content-classroom" id="cpp-cuaderno-main-content">
            ...
            <div id="cpp-programador-app">
                <div class="cpp-main-tabs-content">
                    ...
                    <div id="cpp-main-tab-actividades" class="cpp-main-tab-content"></div>
                        ...
                        <div class="cpp-alumnos-view-container">
                            <div class="cpp-alumnos-view-sidebar">
                                <div class="cpp-alumnos-search-bar">
                                    <div class="cpp-form-group">
                                        <select id="cpp-alumnos-class-filter" name="clase_id_filter" style="margin-bottom: 10px;">
                                ...
                                <div id="cpp-alumnos-search-results" class="cpp-alumnos-list">
                                    <p class="cpp-cuaderno-cargando">Cargando alumnos...</p>
                                </div>
                            </div>
