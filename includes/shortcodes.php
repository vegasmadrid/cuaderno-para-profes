            ...
            <div class="cpp-modal" id="cpp-modal-actividad-evaluable-cuaderno">
                <div class="cpp-modal-content">
                    ...
                    <form id="cpp-form-actividad-evaluable-cuaderno" novalidate>
                        ...
                        <div class="cpp-form-group"><label for="fecha_actividad_cuaderno_input">Fecha (opcional):</label><input type="date" id="fecha_actividad_cuaderno_input" name="fecha_actividad"><div id="cpp-fecha-actividad-display" style="display: none; padding: 8px 0; font-size: 14px; color: #555;"></div></div>
