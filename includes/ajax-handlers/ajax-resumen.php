...
error_log('DEBUG: ajax-resumen.php se está cargando.');
...
error_log('DEBUG: Dependencias de ajax-resumen.php cargadas.');

add_action('wp_ajax_cpp_get_resumen_data', 'cpp_ajax_get_resumen_data');

function cpp_ajax_get_resumen_data()
{
    error_log('DEBUG: Entrando en cpp_ajax_get_resumen_data.');
    try {
        ...
        error_log('DEBUG: Comprobando si la función cpp_obtener_clases_usuario existe: ' . function_exists('cpp_obtener_clases_usuario'));
        ...
        error_log('ERROR FATAL en cpp_ajax_get_resumen_data: ' . $e->getMessage());
        error_log($e->getTraceAsString());
        wp_send_json_error(['message' => 'Error en el servidor: ' . $e->getMessage()], 500);
    }
}
