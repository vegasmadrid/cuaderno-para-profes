...
def run(page: Page):
    """
    This script verifies the redesign of the 'Horario' tab.
    """
    ...
    # Wait for the new schedule header to be visible
    expect(page.locator(".cpp-horario-header h2")).to_have_text("Mi Horario")

    # Wait for the table to be rendered
    expect(page.locator("#cpp-horario-table")).to_be_visible()

    # Take a screenshot
    screenshot_path = "jules-scratch/verification/horario_redesign.png"
